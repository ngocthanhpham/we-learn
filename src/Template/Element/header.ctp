                ...
                <div class='item one active' style="background-image: url(<?=$this->Url->build('/', true)?>webroot/img/banner-home-1.png);">
                    <div class='carousel-caption hidden-xs target'>
                        <div class='container container-carousel animated fadeInUp'>
                            ...
                            <a class='button' href='<?=$this->Url->build('/', true).'tat-ca-khoa-hoc'?>'>Khám phá ngay</a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <li>
                                        <div class='row speical-row'>
                                            <div class='col-sm-6 col-md-4 object'>
                                                ...
                                                <p>
                                                    <a href='<?=$this->Url->build('/tat-ca-khoa-hoc', true);?>'>Sắp bắt đầu</a>
                                                </p>

                                                <p>
                                                    <a href='<?=$this->Url->build('/tat-ca-khoa-hoc', true);?>'>Mới nhất</a>
                                                </p>

                                                <p>
                                                    <a href='<?=$this->Url->build('/tat-ca-khoa-hoc', true);?>'>Được xem nhiều nhất</a>
                                                </p>

                                                <p>
                                                    <a href='<?=$this->Url->build('/tat-ca-khoa-hoc', true);?>'>Được đánh giá cao nhất</a>
                                                </p>

                                                <p class='button-all'>
                                                    <a href='<?=$this->Url->build('/tat-ca-khoa-hoc', true);?>'>Khám phá ngay</a>
                                                </p>
                                            </div>
